...
phrase=(''.join(e for e in phrase if e.isalnum())).lower() #Removing spaces and special characters 
                                                            # and lowercase all.
rphrase=reversed(phrase)                                    #reversing the string
if list(rphrase) == list(phrase):                           #Checking if reversed string is same as
    print("It is a Palindrome")                             #Original and printing appropriate mssg
else:
